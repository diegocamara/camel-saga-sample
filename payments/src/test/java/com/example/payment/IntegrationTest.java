...
import com.example.payment.infrasctructure.repository.reactive.ReactiveOperationRepository;
...
public class IntegrationTest {
  ...
  protected static final ReactiveAccountRepository reactiveAccountRepository =
      configurableApplicationContext.getBean(ReactiveAccountRepository.class);
